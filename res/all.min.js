...
!function(t,e){"use strict";t.fn.hideAllTooltips=function(){return this.each(function(){t(this).find("[data-tooltip-id]").each(function(){if(!t(this).data("tooltip-keep")){var e=t(this).attr("data-tooltip-id");e&&e.length&&t("#"+e).hide()}})})},t.fn.destroyAllTooltips=function(){return this.each(function(){t(this).find("[data-tooltip-id]").each(function(){var e=t(this).attr("data-tooltip-id");e&&e.length&&t("#"+e).remove()})})},t.fn.addTooltip=function(o,i){typeof o===UNDEF||"string"==typeof o||o.jquery||(i=o,o=null),i=t.extend({},t.fn.addTooltip.defaults,i);var n=function(e){var o=!1;return!(e.is(":hidden")||e.css("opacity")<.5)&&(e=e.parents().each(function(){if(t(this).is(":hidden")||t(this).css("opacity")<.5)return o=!0,!1}),!o)};return this.each(function(){if(this["data-tooltip-id"])return!0;var a,r,s,u,l,c=t(this),d=!1,f=!1,p=!1,h="_ltt_"+Math.floor(1e4*Math.random()),m=function(t){s=clearTimeout(s),d=!0},T=function(t){f||(s=clearTimeout(s),d=!1,s=setTimeout(y,100))},y=function(){d||(r=clearTimeout(r),s=clearTimeout(s),a&&a.css({opacity:0}).one("transitionend",function(){t(this).css({display:"none"})}))},v=function(){var o=c.offset();s=clearTimeout(s),(!u||Math.abs(o.top-u.top)<1&&Math.abs(o.left-u.left)<1)&&(i.exclusive&&(c.data("tooltip-keep",!0),e.hideAllTooltips(c),c.data("tooltip-keep",null)),a.css({opacity:0,display:"block"}).alignTo(c,{gap:i.gap,pos:i.pos}).css({opacity:1}).one("transitionend",function(){t(this).css({display:"block"})})),u=o},g=function(){return!!a&&a.is(":visible")&&a.css("opacity")>.99},b=function(e){c.off("."+h),r=clearTimeout(r),s=clearTimeout(s),t("#"+c.attr("data-tooltip-id")).remove(),c.attr("data-tooltip-id",null)};c.attr("data-tooltip-id",h).on("destroyTooltip",b).on("removeTooltip",y).on("focus."+h+" mouseenter."+h,function(e){if(n(t(e.target))){if(p=g(),l=new Date,u=c.offset(),a)s=clearTimeout(s);else if(!(a=function(e,o){var n;if(o)if("string"==typeof o)n=t("<div>",{html:o}).appendTo("body");else{if(!o.jquery)return null;n=t.contains(document.body,o[0])?o:o.appendTo("body")}else{if((o=e.data("tooltip"))?("."===o.charAt(0)?o=e.find(o).eq(0):"#"===o.charAt(0)&&(o=t(o)),o.jquery&&o.removeClass("hidden")):(o=e.attr("title"),e.removeAttr("title")),!o||!o.length)return null;n=t("<div>",{html:o}).appendTo("body")}return n.is(":empty")?null:(n.attr("id",e.attr("data-tooltip-id")).addClass(i.className).attr("role","tooltip").attr("aria-hidden",!0).hide().append(t("<span>",{class:i.nub})),n)}(c,o))||(a.on("mouseover."+h,m).on("mouseout."+h,T),a.find("input, textarea").on("focus."+h,function(){f=!0,m()}).on("blur."+h,function(){f=!1}),0))return b(),!0;r=clearTimeout(r),"mouse"===whatInput.ask("intent")&&(r=setTimeout(v,i.delay))}return!0}).on("blur."+h+" mouseleave."+h,function(e){n(t(e.target))&&(s=clearTimeout(s),s="mouse"===whatInput.ask("intent")?setTimeout(y,100):setTimeout(y,3e3))}).on("click."+h,function(e){if(n(t(e.target))){if(r=clearTimeout(r),"mouse"!==whatInput.ask("intent")){var o=new Date;if(i.touchToggle||o-l>1e3)return!(!function(o){var i=t(e.target).closest("a");return i.length&&i.attr("href")&&!i.attr("href").startsWith("javascript")}()||!g())||(function(t){t.preventDefault(),r=clearTimeout(r),s=clearTimeout(s)}(e),p?y():v(),!1)}p&&(s=clearTimeout(s),y()),d=!1}return!0})})},t.fn.addTooltip.defaults={delay:50,className:"tooltip",nub:"nub",stay:2e3,exclusive:!0,touchToggle:!1,pos:[1,2,1,0],gap:6}}(jQuery,$("body"));
...
!function(e,t,a,n,o){"use strict";e.fn.skin=function(o){o=e.extend({},e.fn.skin.defaults,o);var i,r,l,s,d,c,u,h,f=e(this).eq(0),p="lucid_skin",m=e("[data-audioplayer]"),g=m.length&&!m.data("paused"),v=getTranslations({newItem:"NEW",atFirstPage:"At first page",atLastPage:"At last page",atLastPageQuestion:"Where to go next?",startOver:"Start over",backToHome:"Back to home",upOneLevel:"Up one level",previousFolder:"Previous folder",nextFolder:"Next folder",download:"Download",print:"Print",metaBtn:"Photo data",clickToOpen:"Click to open this document with the associated viewer!"}),w=e("#lightbox"),y=e("#thumbnails"),C=e("#thumbnails .thumb-cont"),b=C.find(".thumb"),k=e("#controls"),T=e("#panels"),F=(e("#navigation"),e("#numbers")),A=0,P=0,x=1,D=!1,N=!1,S=new Date-1e4,O="",E=!1,M=new Date/1e3,L=null,I=null,U=null,z=null,q=null,H=!1,B=function(e){if(e)for(var t=0;t<b.length;t++)if(b.eq(t).attr("href").getFile()===e)return t;return-1},V=function(){if(window.location.hash!==O){O=window.location.hash;var e=readParam();if(e.hasOwnProperty("img")){var t=B(e.img);t>=0?le(t):removeParam(o.indexName,"img")}}},W=function(){f.addClass(o.fullscreenClass),e("html").fullScreen(!0)},X=function(){f.removeClass(o.fullscreenClass),e("html").fullScreen(!1)},j=function(e,t){var a=b.eq(typeof t===UNDEF?A:t).data("vars"),n=e.split(",");if(a&&(a=a.type))for(var o=0;o<n.length;o++)if(n[o]===a)return!0;return!1},Q=function(t){t.each(function(){var a=this.id;e("#controls [data-rel="+a+"]").removeClass("on"),t.translateYAndFade(-16,0,500,function(){e(this).css("display","none")})})},K=function(t,a,n){var i,r,l,s,d=f.hasClass("thumbs-left")||f.hasClass("thumbs-right"),c=d?C.height():C.width(),u=e();i=typeof a===UNDEF?d?C.scrollTop():C.scrollLeft():a,C.find("a."+o.lazyloadClass).filter(function(){var t=e(this).position()[d?"top":"left"]+i;return t+c/2>=0&&t-2*c<=0}).each(function(){(r=e(this)).children("img").length||(s=r.data("vars").thumb)&&(l=e("<img>",{class:o.hideImageClass}).one("load",function(){e(this).addClass(o.showImageClass).removeClass(o.hideImageClass),e(this).parent().removeClass(o.lazyloadClass)}).attr("src",o.thumbsDir+"/"+s).appendTo(r),u.append(l))}),e.isFunction(n)&&(u.length?u.waitAllImg(n):n.call())},Y=function(e){return i.children("[data-rel="+e+"]")},_=function(){f.removeClass("paused").addClass("playing"),!o.auto&&o.backgroundAudioSlideshowControl&&m.trigger("fadeInPlayer"),q=clearTimeout(q),o.auto=!0,q=setTimeout(ce,h.delay/4),N=!1},R=function(){o.auto&&o.backgroundAudioSlideshowControl&&m.trigger("fadeOutPlayer"),f.removeClass("playing").addClass("paused"),q=clearTimeout(q),o.auto=!1,N=!1},Z=function(){H=!1,q=setTimeout(ce,h.delay/4),o.backgroundAudioSlideshowControl&&m.trigger("fadeInPlayer"),f.removeClass("paused").addClass("playing")},G=function(t){o.auto?(f.removeClass("playing").addClass("paused"),o.backgroundAudioSlideshowControl&&m.trigger("fadeOutPlayer"),H=!0,q=clearTimeout(q)):o.muteBackgroundAudio&&(g=!m.data("paused"))&&m.trigger("fadeOutPlayer"),e(this).closest("."+o.cardClass).addClass("playing")},J=function(t){o.auto?Z():o.muteBackgroundAudio&&g&&m.trigger("fadeInPlayer"),e(this).closest("."+o.cardClass).removeClass("playing")},$=function(){var e=typeof e===UNDEF?A:e,t=Y(e),a=t.length?t.find("video,audio")[0]:null;if(a)if(a.paused){var n=a.play();n&&n.catch(function(e){console.log("Autoplay has prevented by the browser. "+e),a.muted||(a.muted=!0,n=a.play())})}else a.pause()},ee=function(){g=!1,o.auto&&Z()},te=function(){var e=window.getComputedStyle(i[0],null);i[0].style.transform=e.transform},ae=function(e,t){var a=Y(e);if(a.length){var n=(w.outerWidth()-a.outerWidth())/2-a.position().left;typeof t!==UNDEF?i.translateX(n,t):i.translateX(n)}},ne=function(){N&&(ae(A),N=!1)},oe=function(){var t=w.width()*h.fillHorz,a=w.height()*h.fillVert;w.removeClass("landscape portrait").addClass(t>=a?"landscape":"portrait"),te(),i.children().each(function(){var n=e(this),i=n.data("rel");if(null!==i&&i>=0&&i<b.length){var r,l=b.eq(i);if(l.length&&(r=l.data("vars"))){var s,d=r.width,c=r.height;s=o.scaleUp?Math.min(t,d*a/c):d/t>c/a?Math.min(d,t):Math.min(d,d*a/c),n.width(s)}}}),ae(A)},ie=function(){switch(i.removeClass("bwd fwd"),x&&i.addClass(x>0?"fwd":"bwd"),e(".map-root").trigger("resetMarkers"),o.transitionType){case"conveyor":var t=function(){ae(P,N?Math.min(350,h.adaptiveSpeed):h.adaptiveSpeed),N=!1,i.one("transitionend",function(e){e.originalEvent.target===this&&window.requestAnimationFrame(a)})},a=function(){re(P)};window.requestAnimationFrame(function(){var e=Y(P);i.children("."+o.currClass).removeClass(o.currClass),e.length&&(e.removeClass(o.nextClass+" "+o.prevClass).addClass(o.currClass),e.prevAll().removeClass(o.nextClass).addClass(o.prevClass),e.nextAll().removeClass(o.prevClass).addClass(o.nextClass)),x||N?setTimeout(function(){window.requestAnimationFrame(t)},50):re(P)})}o.auto&&!H&&(clearTimeout(q),q=setTimeout(ce,h.delay+h.speed)),A=P},re=function(t){!function(e){j("video,audio",e)&&(o.videoAuto?function(e){var e=typeof e===UNDEF?A:e,t=Y(e),a=t.length?t.find("video,audio")[0]:null;if(a){var n=a.play();n&&n.catch(function(e){console.log("Autoplay has prevented by the browser. "+e),a.muted||(a.muted=!0,n=a.play())})}}(P):function(e){var e=typeof e===UNDEF?A:e,t=Y(e),a=t.length?t.find("video,audio")[0]:null;a&&a.pause()}(P))}(t),e(".map-root").is(":visible")&&e(".map-root").trigger("setActive",t)},le=function(t){var a=new Date;t<0||t>=b.length||a-S<200||(P=t,x=function(e){if(D){if(A===b.length-1&&0===e)return 1;if(!A&&e===b.length-1)return-1}return e===A?0:e>A?1:-1}(),h.adaptiveSpeed=Math.minMax(h.speed/5,a-S,h.speed),S=a,A!==P||i.is(":empty")?function(){var t,a,n=e(),r=function(t){var a,r,l,s,d,c,u,f,p,m=w.width()*h.fillHorz,g=w.height()*h.fillVert,y=0,C=D?(t+b.length)%b.length:t;if((a=Y(C)).length||(a=e("<div>",{id:"card_"+t,"data-rel":C,class:o.cardClass})),C>=0&&C<b.length)if((s=a.children("img,video,object")).length)"VIDEO"===s[0].nodeName&&s[0].pause();else{switch(l=b.eq(C),u=l.data("vars"),a.addClass(u.type),f=u.width,p=u.height,y=o.scaleUp?Math.min(m,f*g/p):f/m>p/g?Math.min(f,m):Math.min(f,f*g/p),a.width(y),u.type){case"image":s=e("<img>").one("load",function(t){e(this).addClass(o.loadedClass)}).attr("src",l.attr("href")).appendTo(a);break;case"video":s=e("<video>",{controls:!0}).one("loadedmetadata",function(t){e(this).addClass(o.loadedClass)}).on("play",G).on("pause",J).on("ended",ee).attr("src",l.attr("href")).appendTo(a)}if(d=e("<div>",{class:o.captionClass+" "+o.captionStyle+" "+o.captionPlacement}).appendTo(a),u.caption&&e(u.caption).addClass("text").appendTo(d),c=e("<div>",{class:o.buttonsClass}),o.printImage&&"image"===u.type&&!o.rightClickProtect&&e("<a>",{class:"btn icon-printer",title:v.print}).on("click",function(e){return printImage(u.original&&o.showDownload?u.original:l.attr("href"),(u.original||l.attr("href")).getFile()||"",u.caption||""),!1}).appendTo(c),o.showDownload&&("image"===u.type||o.allowDownloadOthers)){var k=u.original;!k&&o.allowDownloadScaled&&(k=l.attr("href")),k&&e("<a>",{class:"btn icon-download",download:"",href:k,title:v.download}).appendTo(c)}u.photodata&&e("<a>",{class:"btn icon-camera meta",title:'<div class="photodata">'+u.photodata+"</div>"}).appendTo(c),c.is(":empty")||(d.append(c),c.children().addTooltip()),o.rightClickProtect&&s.on("contextmenu",function(e){return e.preventDefault(),!1}),C<=P&&(n=n.add(s))}else a.addClass("blank").show(),a.find("img").addClass(o.loadedClass);t===P?(r=Y(t+1)).length?r.before(a):(r=Y(t-1)).length?r.after(a):i.append(a):t<P?(r=Y(t+1)).length?(r.before(a),y&&i.translateX(i.translateX()-y)):i.prepend(a):(r=Y(t-1)).length?r.after(a):i.append(a)},l=function(){var e;for(r(P),e=P-1;e>=t;e--)r(e);for(e=P+1;e<=a;e++)r(e);N||ae(A),n.length?1===n.length?n.one("load loadedmetadata",ie):n.waitAllImg(ie):ie()};L=clearTimeout(L),t=P-h.before,x<0&&t--,a=P+h.after,x>0&&a++,window.requestAnimationFrame(function(){i.is(":empty")&&l();var n=Y(P);n.length?(n.nextAll().filter(function(){var t=e(this).data("rel");return D?t>P&&t>a||t<P&&t>a-b.length:t>a}).remove(),window.requestAnimationFrame(function(){var a=i.translateX(),o=n.prevAll().filter(function(){var a=e(this).data("rel");return D?a<P&&a<t||a>P&&a<t+b.length:a<t});o.each(function(){a+=e(this).width()}),o.remove(),i.translateX(a),window.requestAnimationFrame(l)})):l()})}():ie(),function(e){b.removeClass(o.activeClass).eq(typeof e!==UNDEF?e:A).addClass(o.activeClass)}(P),function(e){var t=b.eq(e),a=t.attr("href").getFile();addParam(o.indexName,{img:a},t.attr("title")||a.stripExt())}(P),o.showNumbers&&function(e){F.length&&F.html("<h2>"+e+"</h2><p>"+b.length+"</p>")}(P+1))},se=function(t){te();var a=(typeof t!==UNDEF?t:i.translateX())-w.width()/2,n=999999,r=null;i.children().each(function(){var t=e(this).position().left+e(this).width()/2,o=Math.abs(a+t);o<n&&(n=o,r=e(this).data("rel"))}),null!==r&&r!==A?(D?r>=b.length?le(0):r<0&&le(b.length-1):"nextfolder"===o.afterLast&&(r>=b.length&&o.nextFoldersFirst?(R(),window.location.href=o.nextFoldersFirst):r<0&&o.previousFoldersLast&&(R(),window.location.href=o.previousFoldersLast)),le(Math.minMax(0,r,b.length-1))):ne()},de=function(){if(Q(y),N=!1,A)le(A-1);else{switch(R(),o.afterLast){case"donothing":case"onelevelup":case"ask":R();break;case"nextfolder":R(),o.previousFoldersLast&&(window.location.href=o.previousFoldersLast);break;case"startover":return void le(b.length-1)}ne()}},ce=function(){if(Q(y),N=!1,A<b.length-1)le(A+1);else{switch(o.afterLast){case"donothing":R();break;case"startover":return void le(0);case"onelevelup":R(),o.level&&(window.location.href="../"+o.indexName);break;case"nextfolder":R(),o.nextFoldersFirst&&(window.location.href=o.nextFoldersFirst);break;case"ask":R();var t=new Array;return ne(),b.length>1&&t.push({t:v.startOver,c:"icon-loop",h:function(e){le(0)}}),o.level&&t.push({t:v.upOneLevel,c:"icon-up-one-level",h:function(){window.location.href="../"+o.indexName}}),o.nextFoldersFirst&&t.push({t:v.nextFolder,c:"icon-arrow-right",h:function(){window.location.href=o.nextFoldersFirst}}),void f.modal(e("<p>",{class:"text-center",text:v.atLastPageQuestion}),t,{onClose:function(){le(b.length-1)},class:"secondary",title:v.atLastPage})}ne()}};return function(){if(window.location.search&&removeSearch(),o.hasOwnProperty("share")&&(e.fn.renderShares.defaults.buttonTheme=o.share.buttonTheme||"dark",e.fn.renderShares.defaults.facebookAppId=o.share.facebookAppId||"",e(o.share.hook).renderShares(o.share)),t.on("hashchange."+p,V),window.location.hash){var m=window.location.hash.match(/img=(.+)/);m&&(-1!==(A=B(m[1]))?(E=!0,o.auto=!1):A=0)}k.find("[data-rel]").each(function(){var t=e(this);e("#"+t.data("rel")).length?t.addClass("has-panel").on("selectstart."+p,function(e){return e.preventDefault(),!1}).on("click."+p,function(){var t=e(this),a=t.data("autoclose"),n=e("#"+t.data("rel"));if(n.length)if(n.is(":visible"))Q(n);else if(Q(T.children(":visible")),function(t){t.each(function(){var t=e(this),a=this.id,n=k.find("[data-rel="+a+"]:visible");n.addClass("on"),t.css({left:Math.min(n.position().left,T.outerWidth()-t.outerWidth()),opacity:0,transform:"translateY(-16px)",display:"flex"}),window.requestAnimationFrame(function(){t.translateYAndFade(0,1,500,function(){e(this).css("display","flex"),"thumbnails"===a&&K()})})})}(n),a){var o,i;n.add(t).on("mouseenter."+p,function(){i=!0,o=clearTimeout(o)}).on("mouseover."+p,function(){i=!0}).on("mouseleave."+p,function(){clearTimeout(o),i=!1,o=setTimeout(function(){i||Q(n)},a)})}}):t.removeAttr("data-rel")}),y.length&&function(){var t,a,n=o.hasOwnProperty("markNew")?M-o.markNew.days*ONEDAY_S:null;b.each(function(o){e(this).data("rel",o).on("click",function(t){return"SPAN"!==t.target.nodeName&&(y.hideAllTooltips(),Q(y),le(e(this).data("rel"))),!1}),TOUCHENABLED||e(this).addTooltip(),n&&(t=e(this).data("vars").date)&&t>=n&&(a=e("<span>",{class:"icon-star new-image"}).appendTo(e(this)),TOUCHENABLED||a.data("tooltip",new Date(1e3*t).toLocaleDateString()).addTooltip())}),o.rightClickProtect&&C.on("contextmenu","img",function(e){return e.preventDefault(),!1}),C.on("scroll."+p,function(){clearTimeout(z),z=setTimeout(K,100)})}(),e("[data-audioPlayer]").length&&e("[data-audioPlayer]").audioPlayer({rootPath:o.rootPath,target:"playlist"}),o.hasOwnProperty("map")&&o.hasOwnProperty("map")&&(e(".map-root").addMap({markers:function(){var t=[];return b.each(function(a){var n=e(this).data("vars");typeof n!==UNDEF&&n.hasOwnProperty("location")&&t.push({title:[a+1+".",e(this).attr("title")].join(" "),pos:n.location,link:a})}),t}(),type:o.map.type||"roadmap",zoom:o.map.zoom||16,apiKey:o.map.apiKey,fitBounds:!0,fullscreenControl:!1,onMarkerClick:function(){this.hasOwnProperty("link")&&le(this.link)}}),e("#map-btn").on("click",function(){e(".map-root").data("rendered")||setTimeout(function(t){t.hasClass("on")&&e(".map-root").trigger("render")},20,e(this))})),w.length&&(function(){if(w.data("settings")&&e.extend(setting,w.data("settings")),(i=w.find("."+o.cardsClass)).length||(i=e("<div>",{class:o.cardsClass}).appendTo(w)),h=o.defaults[o.transitionType||"conveyor"],o.hasOwnProperty("transitionSpeed")&&(h.speed=o.transitionSpeed),o.hasOwnProperty("slideshowDelay")&&(h.delay=o.slideshowDelay),o.hasOwnProperty("fillHorz")&&(h.fillHorz=o.fillHorz/100),o.hasOwnProperty("fillVert")&&(h.fillVert=o.fillVert/100),D="startover"===o.afterLast,1===b.length?h.after=h.before=0:(h.after=Math.min(h.after,Math.ceil(b.length/2)),h.before=Math.min(h.before,Math.floor(b.length/2))),o.enableMouseWheel){var m=null;w.on("mousewheel."+p+" DOMMouseScroll."+p,function(e){return m=clearTimeout(m),m=setTimeout(e.originalEvent.wheelDelta>0||e.originalEvent.detail<0?de:ce,100),!1})}b.length>1&&((r=k.find(".previous")).on("click."+p,de),(s=k.find(".play")).on("click."+p,_),(d=k.find(".pause")).on("click."+p,R),(l=k.find(".next")).on("click."+p,ce)),o.showFullscreen&&((c=k.find(".fullscreen.btn")).length&&c.on("click."+p,W),(u=k.find(".windowed.btn")).length&&u.on("click."+p,X)),o.enableKeyboard&&a.on("keyup."+p,function(e){if(!f.length||w.children(".modal:visible").length||document.activeElement&&("INPUT"===document.activeElement.nodeName||"TEXTAREA"===document.activeElement.nodeName))return!0;switch(e.preventDefault(),e.keyCode){case 10:case 13:Q(y);break;case 33:case 37:de();break;case 34:case 39:ce();break;case 97:case 35:le(b.length-1);break;case 103:case 36:le(0);break;case 106:case 179:q?R():_();break;case 107:toggleZoom();break;case 32:j("video,audio")?$():q?R():_();break;default:return!0}return!1});var g=0,v=function(t){var a=new Date;if(a-g>100){if(g=a,y.is(":visible"))return Q(y),!1;if("BUTTON"!==t.target.nodeName&&"A"!==t.target.nodeName){var n=e(t.target).closest("."+o.cardClass);if(n.length&&n.data("rel")!==A)return le(n.data("rel")),!1;if(j("video,audio"))return $(),!1}}return!0};i.swipe({onSwipedRight:function(e){N=!0,clearTimeout(I),I=setTimeout(se,50,i.data("targetPos"))},onSwipedLeft:function(e){N=!0,clearTimeout(I),I=setTimeout(se,50,i.data("targetPos"))},onSwipeStart:function(){n.hideAllTooltips(),R()},onClick:v}).on("click."+p,v),t.on("resize."+p,function(){clearTimeout(U),U=setTimeout(oe,100)})}(),le(A)),e("[data-tooltip]").addTooltip(),o.auto&&w.length&&b.length>1&&_()}(),this},e.fn.skin.defaults={activeClass:"active",lazyloadClass:"lazyload",thumbsDir:"thumbs",indexName:"index.html",cardsClass:"cards",cardClass:"card",currClass:"curr",prevClass:"prev",nextClass:"next",loadedClass:"loaded",captionClass:"caption",buttonsClass:"buttons",hideImageClass:"hide-image",showImageClass:"show-image",fullscreenClass:"fullscreen",clickForNext:!0,backgroundAudioSlideshowControl:!1,muteBackgroundAudio:!0,videoAuto:!1,videoLoop:!1,volume:.5,auto:!1,afterLast:"donothing",rightClickProtect:!1,allowDownloadOthers:!1,showNumbers:!0,transitionType:"conveyor",captionStyle:"dark",captionPlacement:"center bottom",showFullscreen:!0,enableKeyboard:!0,enableMouseWheel:!0,scaleUp:!1,fillHorz:90,fillVert:100,defaults:{conveyor:{before:2,after:2,delay:1e3,speed:2e3,fillHorz:.9,fillVert:1},kenburns:{before:1,after:0,delay:0,speed:4e3},crossfade:{before:1,after:0,delay:1e3,speed:2e3},zoom:{before:1,after:0,delay:1e3,speed:2e3},slide:{before:1,after:0,delay:1e3,speed:2e3}},fit:"both"}}(jQuery,jQuery(window),jQuery(document),jQuery("body"));
